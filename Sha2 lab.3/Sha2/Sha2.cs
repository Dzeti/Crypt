...
namespace Sha2
{
    ...
    {
        void HashFile(Stream fs, Stream output);
    }
    public class Sha2 : IHash
    {
        ...
        public  void HashFile(Stream fs, Stream output)
        //ReadOnlyCollection<byte>
        {
            ...
            ReadOnlyCollection<byte> mycollecl = sha.GetHash();
            byte[] arr = new byte[buf.Length];
            mycollecl.CopyTo(arr, 0);
            // sha.GetHash();
